...
export default function BeritaPage() {
  ...
  return (
    <section className="site-frame px-4 py-8 sm:px-8">
      <div className="rounded-4xl border border-[var(--line)] bg-[var(--surface)] p-8">
      ...
      <div className="mt-8 grid gap-4">
        {activeEvent.news.map((item) => (
          <article key={`${item.title}-${item.publishedAt}`} className="rounded-3xl border border-[var(--line)] bg-white p-6">
